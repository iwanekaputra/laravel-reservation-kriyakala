                    ...
                    @enderror" placeholder="081363728192" wire:model="nowa">
                      ...
                      <div class="form-group">
                        ...
                        @foreach ($studios as $studio)
                            <div class="form-check">
                                ...
                                border-danger
                            @enderror" type="radio" name="{{ $studio->name }}" id="{{ $studio->name }}" value="{{ $studio->name }}" wire:model="studio">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-check">
                            ...
                            border-danger
                        @enderror" type="radio" name="{{ $service->name }}" id="{{ $service->name }}1" value="{{ $service->name }}" wire:model="selectService">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-check">
                            ...
                            border-danger
                        @enderror" type="radio" name="{{ $servicePackage->name }}" id="{{ $servicePackage->name }}1" value="{{ $servicePackage->name }}" wire:model="package">
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-check">
                                ...
                                border-danger
                            @enderror" type="checkbox" id="{{ $serviceAdditional->name }}" wire:model="selectedServiceAdditional.{{ $serviceAdditional->id }}" value="{{ $serviceAdditional->name }}">
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-check">
                                ...
                                border-danger
                            @enderror" type="radio" name="{{ $backgroundColor->name }}" id="{{ $backgroundColor->name }}" value="{{ $backgroundColor->name }}" wire:model="mainBackground">
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="form-check">
                                ...
                                border-danger
                            @enderror" type="radio" name="{{ $backgroundColor->name }}-additional" id="{{ $backgroundColor->name }}-additional" value="{{ $backgroundColor->name }}" wire:model="additionalBackground">
                                <label class="form-check-label" for="{{ $backgroundColor->name }}-additional">
                                    {{ $backgroundColor->name }}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="Tidak Perlu-additional" id="Tidak Perlu-additional" value="0" wire:model="additionalBackground">
