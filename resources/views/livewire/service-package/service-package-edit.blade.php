                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                border-danger
                            @enderror "
                                    placeholder="10" wire:model="discountWeekend">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @if ($imageEdit)
                                    <div class="mb-2 mt-2">
                                        <img src="{{ $imageEdit->temporaryUrl() }}" alt="" class="w-50">
                                    </div>
                                @elseif($image)
                                    <div class="mb-2 mt-2">
                                        <img src="{{ Storage::url('galleries/' . $image) }}" alt=""
                                            class="w-50">
                                    </div>
                                @endif
                                ...
                                @enderror
                                <input type="file"
                                    class="form-control @error('imageEdit')
                                border-danger
                            @enderror "
                                    placeholder="100" wire:model="imageEdit">
                            </div>
