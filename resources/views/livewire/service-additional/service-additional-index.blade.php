                                ...
                                <tbody>
                                    @forelse ($serviceAdditionals as $serviceAdditional)
                                        <tr>
                                            ...
                                            <td>{{ $serviceAdditional->servicePackage->name }}</td>
                                            <td>
                                                {{ $serviceAdditional->name }}
                                            </td>
                                            <td>
                                                Rp.
                                                {{ number_format((int) $serviceAdditional->price_weekday, 0, ',', '.') }}
                                            </td>
                                            <td>
                                                Rp.
                                                {{ number_format((int) $serviceAdditional->price_weekend, 0, ',', '.') }}
                                            <td>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.additional.edit', $serviceAdditional->id) }}"
                                                    class="btn btn-info ms-2">Edit</a>
                                                <a wire:click="confirmDelete({{ $serviceAdditional->id }})"
